...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton button0, button1, button2, button3, button4, button5, button6, button7, button8, button9,
            buttonDot, buttonAdd, buttonSub, buttonMultiply, buttonDivide, buttonPercent, buttonClear, buttonOFF, buttonEqual, buttonPaint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPaint = findViewById(R.id.paint);
    ...
    private void allCalculations(){
        if (!Double.isNaN(firstValue)) {
            secondValue = Float.parseFloat(inputDisplay.getText().toString());
            inputDisplay.setText(null);
